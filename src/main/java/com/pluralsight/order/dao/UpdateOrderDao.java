...
public class UpdateOrderDao {
    ...
    private PreparedStatement createPreparedStatement(Connection con, ParamsDto paramsDto) throws SQLException {
        ...
        /*
         * first query parameter to the order status, and the second query parameter to the order ID
         */
        prepStat.setString(1, paramsDto.getStatus());
        prepStat.setLong(2, paramsDto.getOrderId());
        return prepStat;
    }
}
