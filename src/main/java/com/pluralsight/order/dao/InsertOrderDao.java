...
public class InsertOrderDao {
    ...
    private PreparedStatement createOrderPreparedStatement(Connection con, OrderDto orderDto) throws SQLException {
        /*
         * Again, checking the SQL for: order_customer_id, order_date, order_status
         * This is a very convoluted example. For the timestamp you would think you want the orderDto
         * Timestamp.from(orderDto.getDate().toInstant())
         */
    ...
    private PreparedStatement createOrderDetailPreparedStatement(Connection con, OrderDetailDto orderDetailDto) throws SQLException {
        PreparedStatement prepStat = con.prepareStatement(sqlOrderDetail);
        prepStat.setLong(1, orderDetailDto.getOrderId());
        prepStat.setLong(2, orderDetailDto.getProductId());
        prepStat.setInt(3, orderDetailDto.getQuantity());
        return prepStat;
    }
}
